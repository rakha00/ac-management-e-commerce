    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div class="bg-white p-6 md:p-8 rounded-lg shadow-lg max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
                ...
                @php
                    $productImages = [];
                    if (!empty($product->path_foto_produk) && is_array($product->path_foto_produk)) {
                        foreach ($product->path_foto_produk as $foto) {
                            $productImages[] = [
                ...
                <div>
                    ...
                    <div class="space-y-3 mb-8">
                        <button
                            ...
                            @click="loading = true; Livewire.dispatch('add-to-cart', { productId: {{ $product->id }}, type: 'unit' }); setTimeout(() => loading = false, 1000)"
                            :disabled="loading"
