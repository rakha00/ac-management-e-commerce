    ...
    <div style="width: 100%; box-sizing: border-box;">
                ...
                <td style="width: 30%; vertical-align: top; padding: 1px;">
                    ...
                    <div style="border: 1px solid #000; border-top: none; padding: 3px;">
                        ...
                        <div style="margin-top: 3px;">
                            {{ $transaksiProduk->konsumen->nama }}<br>
                            {{ $transaksiProduk->konsumen->alamat }}<br>
                            {{ $transaksiProduk->konsumen->telepon }}
                        </div>
                    </div>
                </td>
            </tr>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 8px;">
            ...
            <tbody>
                @php
                    $total = 0;
                    $item_count = $transaksiProduk->transaksiProdukDetail->count();
                    $items = $transaksiProduk->transaksiProdukDetail;
