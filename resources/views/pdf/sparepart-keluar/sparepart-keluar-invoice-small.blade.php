    ...
    <div style="width: 100%; box-sizing: border-box;">
                ...
                <td style="width: 30%; vertical-align: top; padding: 1px;">
                    ...
                    <div style="border: 1px solid #000; border-top: none; padding: 3px;">
                        ...
                        <div style="margin-top: 3px;">
                            {{ $sparepartKeluar->konsumen->nama }}<br>
                            {{ $sparepartKeluar->konsumen->alamat }}<br>
                            {{ $sparepartKeluar->konsumen->telepon }}
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="vertical-align: top; padding: 1px; padding-top: 5px;">NO. INVOICE :
                    {{ $sparepartKeluar->nomor_invoice }}
                </td>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 8px;">
            ...
            <tbody>
                @php
                    $total = 0;
                    $item_count = $sparepartKeluar->detailSparepartKeluar->count();
                    $items = $sparepartKeluar->detailSparepartKeluar;
                ...
                @forelse($items as $index => $detail)
                    @php
                        ...
                        $total += $detail->harga_jual * $detail->jumlah_keluar;
                    @endphp
                    <tr>
                        <td
