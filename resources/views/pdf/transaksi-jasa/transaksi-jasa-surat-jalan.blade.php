...
<head>
    <meta charset="UTF-8">
    <title>Transaksi Jasa Surat Jalan - PT Global Servis Int</title>
</head>
                ...
                <div style="border: 1px solid #0072bc; font-size: 8pt; line-height: 1.5;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>: {{ \Carbon\Carbon::parse($transaksiJasa->tanggal_transaksi)->format('d/m/Y') }}</td>
                        </tr>
                        <tr>
                            <td>No. Surat Jalan</td>
                            <td>: {{ $transaksiJasa->nomor_surat_jalan_jasa }}</td>
                        </tr>
                    </table>
                </div>
            </td>
                ...
                <td style="width: 40%; vertical-align: top; padding-left: 20px;">
                    ...
                    <div style="border: 1px solid #0072bc; font-size: 10pt; line-height: 1.5;">
                        <table style="width: 100%;">
                            <tr>
                                <td style="width:45%;">Date</td>
                                <td>: {{ \Carbon\Carbon::parse($transaksiJasa->tanggal_transaksi)->format('d/m/Y') }}
                                </td>
                            </tr>
                            <tr>
                                <td>No. Surat Jalan</td>
