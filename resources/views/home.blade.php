                ...
                @forelse ($unitACs as $ac)
                    <div class="group">
                        <div class="relative mb-5 overflow-hidden">
                            <img src="https://via.placeholder.com/300" alt="{{ $ac->nama_unit }}"
                        ...
                        <div>
                            <h3 class="font-semibold text-xl text-gray-800 mb-2">{{ $ac->nama_unit }}</h3>
                            <p class="text-gray-600 mb-4">{{ Str::limit($ac->keterangan, 100) }}</p>
                            <div class="flex justify-between items-center">
                                <span
                                    class="text-xl font-bold text-blue-700">Rp{{ number_format($ac->harga_ecommerce, 0, ',', '.') }}</span>
                                <a href="#"
                                    class="bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-all duration-300 shadow-md hover:shadow-lg">
                ...
                @forelse ($spareparts as $sparepart)
                    <div class="group">
                        <div class="relative mb-5 overflow-hidden">
                            ...
                            <div
                                class="absolute top-3 right-3 bg-blue-600 text-white text-xs font-semibold px-3 py-1.5 rounded-full">
                                Stok Tersisa: {{ $sparepart->stok_akhir }}
                            </div>
                        </div>
                        <div>
                            <h3 class="font-semibold text-xl text-gray-800 mb-2">{{ $sparepart->nama_sparepart }}</h3>
                            <p class="text-gray-600 mb-4">{{ Str::limit($sparepart->keterangan, 100) }}</p>
                            <div class="flex justify-between items-center">
                                <span
                                    class="text-xl font-bold text-blue-700">Rp{{ number_format($sparepart->harga_ecommerce, 0, ',', '.') }}</span>
                                <a href="#"
                                    class="bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-all duration-300 shadow-md hover:shadow-lg">
                                    <x-fab-whatsapp class="w-5 h-5" />
                                </a>
