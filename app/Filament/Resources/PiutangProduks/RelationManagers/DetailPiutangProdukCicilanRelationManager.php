...
namespace App\Filament\Resources\PiutangProduks\RelationManagers;
...
class DetailPiutangProdukCicilanRelationManager extends RelationManager
{
    protected static string $relationship = 'detailPiutangProdukCicilan';

    protected static ?string $recordTitleAttribute = 'tanggal_cicilan';

    protected static ?string $pluralLabel = 'cicilan piutang produk';

    // Jika perlu, nonaktifkan lazy loading:
    ...
    protected function recalculateParent(): void
    {
        ...
        $totalCicilan = $owner->detailPiutangProdukCicilan()->sum('nominal_cicilan');
