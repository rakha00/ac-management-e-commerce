...
class Sparepart extends Model
{
    ...
    public function merkSparepart(): BelongsTo
    {
        return $this->belongsTo(MerkSparepart::class, 'merk_spareparts_id');
    }
    ...
    protected static function booted(): void
    {
        static::creating(function (Sparepart $model) {
            $model->harga_modal = $model->harga_modal ?? 0;
            $model->harga_ecommerce = $model->harga_ecommerce ?? 0;
